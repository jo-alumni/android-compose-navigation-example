package com.example.navigationtest.app.feature.postDetail
...
import com.example.navigationtest.app.core.ui.component.Comment
...
private fun TweetDetailScreen(
    ...
    Scaffold(
        ...
        uiState.render<PostDetailState.Stable> {
            val lazyScrollState = rememberLazyListState().apply {
                OnBottomReached { onLoadMore() }
            }
            PullToRefreshBox(
                isRefreshing = uiState is PostDetailState.Stable.Loading && uiState.type == PostDetailState.Stable.Loading.Type.REFRESH,
                onRefresh = onRefresh,
            ) {
                Column(
                    modifier = Modifier
